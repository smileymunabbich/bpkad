...
class dbConfigSistem
{
	...
	public function connecting(){
		try{
			...
			//$dns = "mysql:host=localhost;dbname=db_sipp";
			...
			//UNTUK akses SQLServer dari Linux
			//PDO('dblib:dbname=database;host=sqlServer', 'username', 'password');
			
			// $dns = "dblib:dbname=$this->dbName;host=$this->host";
			// $this->dbh = new PDO($dns, $this->user, $this->password);
